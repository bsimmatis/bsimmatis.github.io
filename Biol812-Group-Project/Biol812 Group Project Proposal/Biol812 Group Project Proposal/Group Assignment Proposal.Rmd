...
```{r global_options,include=FALSE}
  ...
  #to ensure plot remains in correct section
```
...
We aim to determine whether (1) chlorophyll a changes over time in each lake, and (2) we "fingerprint" deep vs shallow eutrophic lakes, and, if so, whether the differences correlate to the wavelengths of known specific pigments.
